...
public class XmlExchangeRateController implements XmlExchangeRatesApi {
    ...
    public XmlExchangeRateController(ExchangeRateService exchangeRateService,
        ...
        Objects.requireNonNull(xmlApiMapper, "xmlApiMapper must not be null");
        this.support = new ExchangeRateControllerSupport<>(exchangeRateService, requestLogService, xmlApiMapper);
    }
