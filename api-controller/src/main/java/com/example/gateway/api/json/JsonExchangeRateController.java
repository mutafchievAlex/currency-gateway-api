...
public class JsonExchangeRateController implements JsonExchangeRatesApi {
    ...
    public JsonExchangeRateController(ExchangeRateService exchangeRateService,
        ...
        this.jsonApiMapper = Objects.requireNonNull(jsonApiMapper, "jsonApiMapper must not be null");
    }
    ...
    private ExchangeRateResponse mapCurrent(String requestId, String baseCurrency, String targetCurrency) {
        ...
        return jsonApiMapper.toExchangeRateResponse(rate);
    }
    ...
    private ExchangeRateHistoryResponse mapHistory(String requestId,
        ...
        return jsonApiMapper.toHistoryResponse(history);
    }
