...
public class JsonExchangeRateController implements JsonExchangeRatesApi {
    ...
    public JsonExchangeRateController(ExchangeRateService exchangeRateService,
        ...
        this.support = new ExchangeRateControllerSupport<>(exchangeRateService, requestLogService, jsonApiMapper, validationService);
    }

    @Override
    @GetMapping(value = "/current", produces = org.springframework.http.MediaType.APPLICATION_JSON_VALUE)
